...
public class DOKeyAndValidateUtil{
    ...
    public static int updateUtil(ChineseCulturalDO record, ValidatorImpl validator, ChineseCulturalDOMapper chineseCulturalDOMapper) throws BusinessException {
