(function () {
    require(['jquery', 'ajaxUtil','bootstrapTableUtil','objectUtil','alertUtil','modalUtil','selectUtil','stringUtil','dictUtil'],
        function (jquery,ajaxUtil,bootstrapTableUtil,objectUtil,alertUtil,modalUtil,selectUtil,stringUtil,dictUtil) {
            ...
            var url = "/cul/pro/comGam/getAll?chineseCulturalStatus=已下架&chineseCulturalStatus=展示中";
            ...
            window.orgEvents = {
                'click .edit' : function(e, value, row, index) {
                    ...
                    orange.redirect("/chineseCultural/production/insertComicGame");
                },

                'click .delete': function (e, value, row, index) {
                    var myDeleteModalData ={
                        modalBodyID : "myDeleteModalComGam",
                        modalTitle : "删除动漫游戏信息",
                        modalClass : "modal-lg",
                        confirmButtonClass : "btn-danger",
                        modalConfirmFun:function () {
                            var isSuccess = false;
                            ajaxUtil.myAjax(null,"/cul/pro/comGam/delComGam/"+row.itemid+"/"+row.itemcode,null,function (data) {
                ...
                'click .pass' : function (e, value, row, index) {
                    var myPassTravelModalData ={
                        ...
                        modalConfirmFun:function () {
                            ...
                            ajaxUtil.myAjax(null,"/cul/pro/comGam/cgComGamSta/"+row.itemid+"/"+row.itemcode,submitStatus,function (data) {
                                if(ajaxUtil.success(data)){
                                    if(data.code == 88888){
            ...
            $("#btn_addTask").unbind().on('click',function () {
                var url = "/chineseCultural/production/insertComicGame";
