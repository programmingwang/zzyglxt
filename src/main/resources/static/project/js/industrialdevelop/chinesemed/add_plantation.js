(function () {
    require(['jquery', 'ajaxUtil', 'stringUtil', 'uploadImg', 'urlUtil', 'objectUtil', 'distpicker','alertUtil'],
        function (jquery, ajaxUtil, stringUtil, uploadImg, urlUtil, objectUtil, distpicker,alertUtil) {
            ...
            $("#submitBtn").unbind('click').on('click', function () {
                ...
                if (!stringUtil.isBlank(param.name) && !stringUtil.isBlank(param.plantType) && !stringUtil.isBlank(param.areaCoverd) &&
